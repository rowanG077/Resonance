...
use resonance_audio::data::{
    Arithmetic, Command, Comparison, Controller, Operand, Variable, VolumeCurve,
};
    ...
    pub fn mixer(self) -> Result<Command> {
        ...
        Ok(match operation {
            ...
            Native::SelectController {
                destination: Destination::Reverb,
                scale_16: 0,
                combine: 0,
                variable: true,
                ..
            ...
            Native::SelectController {
                destination: destination @ (Destination::AuxiliaryA | Destination::AuxiliaryB),
                scale_16: 0,
                combine: 0,
                variable: true,
                ..
            } => Command::Auxiliary {
                bus: if matches!(destination, Destination::AuxiliaryA) {
                    0
                } else {
                    1
                },
    ...
    let native = match a as u8 {
        ...
        0x40..=0x4c => {
            let destination = match a as u8 {
                ...
                0x4b => Destination::AuxiliaryA,
                _ => Destination::AuxiliaryB,
            };
...
mod tests {
    ...
    fn lowering_rejects_unimplemented_operands_and_keeps_disabled_vibrato() {
        let unsupported = [
            ...
            Native::SelectController {
                destination: Destination::AuxiliaryA,
                source: 0,
                scale_16: 1,
                combine: 0,
                variable: true,
